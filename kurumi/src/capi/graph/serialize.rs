...
use kurumi_core::{Graph, InputBinding, InputRole, NodeId, deserialize_graph, serialize_graph, serialize_reachable};
...
pub unsafe extern "C" fn ku_graph_deserialize(bytes: *const u8, len: usize) -> *mut KuRunnable {
    ...
    catch(std::ptr::null_mut(), || match deserialize_graph(data) {
